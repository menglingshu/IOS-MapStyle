...
class DetailsView: UIView {
    ...
    func setUI(vo:MapItemInfoVO) {
        let childAray = vo.aryChild
        itemsNum = childAray.count + 1
        itemsAry.removeAllObjects()
        
        /********** main button **************/
        let frame0 = CGRectMake(0, 0, fBigRectD1, fBigRectD1)
        let ps0 = CGPointMake(CGRectGetWidth(frame0) / 2, fBigRectD1 - (fBigRectD1 - fBigCircleD) / 2 - (fBigCircleD_Shadow - fBigCircleD))
        let pe0 = CGPointMake(CGRectGetWidth(frame0) / 2, CGRectGetHeight(frame0))
        let buttonItem0 = ItemView(frame: frame0, buttonFrame: CGRectMake(0, 0, fBigCircleD_Shadow, fBigCircleD_Shadow), lineStart: ps0, lineEnd: pe0) { (btn) -> Void in
        ...
        /**************************************** leftDown button ******************************************************/
        if itemsNum > 1 {
            let frameUD = CGRectMake(0, 0, fSmallRectD_UD, fSmallRectD_UD)
            let ps1 = CGPointMake(CGRectGetWidth(frameUD) / 2 + CGFloat(cosf(Float(M_PI_4))) * fSmallCircleD / 2, CGRectGetHeight(frameUD) / 2 - CGFloat(sinf(Float(M_PI_4))) * fSmallCircleD / 2)
            let pe1 = CGPointMake(CGRectGetWidth(frameUD), 0)
            let buttonItem1 = ItemView(frame: frameUD, buttonFrame: CGRectMake(0, 0, fSmallCircleD_Shadow, fSmallCircleD_Shadow), lineStart: ps1, lineEnd: pe1) { (btn) -> Void in
                self.clickButton(btn as! ItemView)
            }
            buttonItem1.button.setBackgroundImage(UIImage(named: ""), forState: UIControlState.Normal)
            ...
            /**************************************** rightDown button ******************************************************/
            if (itemsNum > 2) {
                let ps2 = CGPointMake(CGRectGetWidth(frameUD) / 2 - CGFloat(cosf(Float(M_PI_4))) * fSmallCircleD / 2, CGRectGetHeight(frameUD) / 2 - CGFloat(sinf(Float(M_PI_4))) * fSmallCircleD / 2)
                let pe2 = CGPointMake(0, 0)
                let buttonItem2 = ItemView(frame: frameUD, buttonFrame: CGRectMake(0, 0, fSmallCircleD_Shadow, fSmallCircleD_Shadow), lineStart: ps2, lineEnd: pe2, block: { (btn) -> Void in
                    self.clickButton(btn as! ItemView)
                })
                ...
                /**************************************** leftMid button ******************************************************/
                if (itemsNum > 3) {
                    let frameMid = CGRectMake(0, 0, fSmallRectD_Mid, fSmallRectD_Mid)
                    let ps3 = CGPointMake((CGRectGetWidth(frameMid) + fSmallCircleD) / 2, CGRectGetHeight(frameMid) / 2)
                    let pe3 = CGPointMake(CGRectGetWidth(frameMid), CGRectGetHeight(frameMid) / 2)
                    let buttonItem3 = ItemView(frame: frameMid, buttonFrame: CGRectMake(0, 0, fSmallCircleD_Shadow, fSmallCircleD_Shadow), lineStart: ps3, lineEnd: pe3, block: { (btn) -> Void in
                        self.clickButton(btn as! ItemView)
                    })
                    ...
                    /**************************************** rightMid button ******************************************************/
                    if (itemsNum > 4) {
                        let ps4 = CGPointMake((CGRectGetWidth(frameMid) - fSmallCircleD) / 2, CGRectGetHeight(frameMid) / 2)
                        let pe4 = CGPointMake(0, CGRectGetHeight(frameMid) / 2);
                        let buttonItem4 = ItemView(frame: frameMid, buttonFrame: CGRectMake(0, 0, fSmallCircleD_Shadow, fSmallCircleD_Shadow), lineStart: ps4, lineEnd: pe4, block: { (btn) -> Void in
                            self.clickButton(btn as! ItemView)
                        })
                        ...
                        if (itemsNum > 5) {
                            ...
                            //leftup button
                            let ps5 = CGPointMake(CGRectGetWidth(frameUD) / 2 + CGFloat(cosf(Float(M_PI_4))) * fSmallCircleD / 2, CGRectGetHeight(frameUD) / 2 + CGFloat(sinf(Float(M_PI_4))) * fSmallCircleD / 2)
                            let pe5 = CGPointMake(CGRectGetWidth(frameUD), CGRectGetHeight(frameUD))
                            let buttonItem5 = ItemView(frame: frameUD, buttonFrame: CGRectMake(0, 0, fSmallCircleD_Shadow, fSmallCircleD_Shadow), lineStart: ps5, lineEnd: pe5, block: { (btn) -> Void in
                                self.clickButton(btn as! ItemView)
                            })
                            ...
                            /**************************************** rightup button ******************************************************/
                            if (itemsNum > 6) {
                                let ps6 = CGPointMake(CGRectGetWidth(frameUD) / 2 - CGFloat(cosf(Float(M_PI_4))) * fSmallCircleD / 2, CGRectGetHeight(frameUD) / 2 + CGFloat(sinf(Float(M_PI_4))) * fSmallCircleD / 2)
                                let pe6 = CGPointMake(0, CGRectGetHeight(frameUD))
                                let buttonItem6 = ItemView(frame: frameUD, buttonFrame: CGRectMake(0, 0, fSmallCircleD_Shadow, fSmallCircleD_Shadow), lineStart: ps6, lineEnd: pe6, block: { (btn) -> Void in
                                    self.clickButton(btn as! ItemView)
                                })
                                ...
                                if (itemsNum > 7) {
                                    //midUp button
                                    let ps7 = CGPointMake(CGRectGetWidth(frameMid) / 2, (CGRectGetHeight(frameMid) - fSmallCircleD) / 2 + fSmallCircleD)
                                    let pe7 = CGPointMake(CGRectGetWidth(frameMid) / 2, CGRectGetHeight(frameMid))
                                    let buttonItem7 = ItemView(frame: frameMid, buttonFrame: CGRectMake(0, 0, fSmallCircleD_Shadow, fSmallCircleD_Shadow), lineStart: ps7, lineEnd: pe7, block: { (btn) -> Void in
                                        self.clickButton(btn as! ItemView)
                                    })
        ...
        for (var i = 0; i < itemsNum; i++) {
            let item: ItemView = itemsAry.objectAtIndex(i) as! ItemView
            if (i != 0) {
                item.labelBottom.text = ""
                Utils.dealViewRoundCorners(item.button, radius: CGRectGetHeight(item.button.bounds)/2, borderWidth: 2)
            }
            let color = Utils.getColorByTag(self.tag)
    ...
    func setItemsTransform(transf:CGAffineTransform) {
        for (var i = 0;i <  itemsNum; i++) {
            let item = itemsAry.objectAtIndex(i) as! ItemView
    ...
    func rotationView(aAngle:CGFloat) {
        ...
        UIView.animateWithDuration(NSTimeInterval(time), animations: { () -> Void in
            let transform = CGAffineTransformMakeRotation(-aAngle)
            self.superview?.layer.anchorPoint = CGPointMake(0.5, 1)
            self.superview?.transform = transform
            let transformItem = CGAffineTransformMakeRotation(aAngle)
    ...
    func appearItems() {
        let buttonItem0 = itemsAry.objectAtIndex(0) as! ItemView
    ...
    func disapperItems(aBlock:() -> Void) {
        if selectItem != nil {
            ...
            let imgView = self.viewWithTag(1000)
        ...
        if itemsNum == 1 {
            ...
            UIView.animateWithDuration(0.2, animations: { () -> Void in
                for (var i = 1; i < self.itemsNum; i++) {
                    let item = self.itemsAry.objectAtIndex(i) as! ItemView
